...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ExtractAPIRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.ExtractResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "dto.ExtractData": {
            ...
            "properties": {
                "transcript": {
                    "description": "Transcript contains the transcribed text from the tiktok video.",
                    "type": "string"
                }
            }
        },
        "dto.ExtractResponse": {
            ...
            "properties": {
                "data": {
                    "description": "Data contains the final extraction results. It is omitted if the job is not yet completed.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/dto.ExtractData"
                        }
                    ]
                },
                "error": {
                    "description": "Error contains the error message if the extraction failed. It is omitted otherwise.",
                    "type": "string"
                },
                "jobId": {
                    "description": "JobID is the unique identifier for the extraction task.",
                    "type": "string"
                },
                "status": {
                    "description": "Status indicates the current state of the extraction job.",
                    "allOf": [
                        {
